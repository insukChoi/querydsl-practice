...
import study.querydslpractice.entity.QMember;
...
import static study.querydslpractice.entity.QTeam.team;
...
public class QuerydslBasicTest {
    ...
    public void resultFetch() {
       /* List<Member> members = queryFactory.selectFrom(member)
        ...
        Member firstMember = queryFactory.selectFrom(QMember.member)
                .fetchFirst();*/
    ...
    public void findDtoByJPQL() {
        List<MemberDto> result = em.createQuery(
                "select new study.querydslpractice.dto.MemberDto(m.username, m.age) " +
